    ...
    <DialogPortal container={portalContainer ?? undefined}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          layout === "centered" &&
            "top-1/2 left-1/2 w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 sm:max-w-md data-open:zoom-in-95 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
